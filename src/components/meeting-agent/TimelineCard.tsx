...
import type { MeetingTimelineEvent } from '@/types/meeting-agent';

type Props = { events: MeetingTimelineEvent[] };

export function TimelineCard({ events }: Props) {
  return (
    <div className="rounded-xl border border-gold-500/12 bg-maroon-900 p-5">
      <h3 className="text-sm font-semibold text-ink-500 mb-4">Meeting Timeline</h3>
