...
import type { ExecutionTimelineEvent } from '@/types/linkedin-execution';

type Props = {
  events: ExecutionTimelineEvent[];
};

export function CampaignTimeline({ events }: Props) {
  return (
    <div className="rounded-xl border border-gold-500/12 bg-maroon-900 p-5">
      <h3 className="text-sm font-semibold text-ink-500 mb-4">Execution Timeline</h3>
