...
import type { ConversationTimelineEvent } from '@/types/conversation-ai';

type Props = {
  events: ConversationTimelineEvent[];
};

export function ConversationTimeline({ events }: Props) {
  return (
    <div className="rounded-xl border border-gold-500/12 bg-maroon-900 p-5">
      <h3 className="text-sm font-semibold text-ink-500 mb-4">Conversation Timeline</h3>
