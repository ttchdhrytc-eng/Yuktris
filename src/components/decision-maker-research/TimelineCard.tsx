...
import type { DMResearchTimelineEvent } from '@/types/decision-maker-research';

type Props = {
  events: DMResearchTimelineEvent[];
};

export function TimelineCard({ events }: Props) {
  return (
    <div className="rounded-xl border border-gold-500/12 bg-maroon-900 p-5">
      <h3 className="text-sm font-semibold text-ink-500 mb-4">Research Timeline</h3>
