...
import type { SNTimelineEvent } from '@/types/sales-navigator';

type Props = {
  events: SNTimelineEvent[];
};

export function TimelineCard({ events }: Props) {
  return (
    <div className="rounded-xl border border-gold-500/12 bg-maroon-900 p-5">
      <h3 className="text-sm font-semibold text-ink-500 mb-4">Search Generation Timeline</h3>
