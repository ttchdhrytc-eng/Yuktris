...
import type { ICPTimelineEvent } from '@/types/icp-intelligence';

type Props = {
  events: ICPTimelineEvent[];
};

export function Timeline({ events }: Props) {
  return (
    <div className="rounded-xl border border-gold-500/12 bg-maroon-900 p-5">
      <h3 className="text-sm font-semibold text-ink-500 mb-4">Generation Timeline</h3>
