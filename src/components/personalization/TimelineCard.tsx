...
import type { PersonalizationTimelineEvent } from '@/types/personalization';

type Props = {
  events: PersonalizationTimelineEvent[];
};

export function TimelineCard({ events }: Props) {
  return (
    <div className="rounded-xl border border-gold-500/12 bg-maroon-900 p-5">
      <h3 className="text-sm font-semibold text-ink-500 mb-4">Personalization Timeline</h3>
