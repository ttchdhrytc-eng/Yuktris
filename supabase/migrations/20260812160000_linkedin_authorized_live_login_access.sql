/* Expose only an active Browserbase Live View URL to the owning workspace member. */
...
BEGIN
  ...
  v_expires_at := v_connected_at + interval '10 minutes';
  ...
  -- Browserbase Live View is the only URL class permitted across this boundary.
  -- Explicitly exclude API, websocket/CDP, and non-HTTPS URLs.
  IF v_url IS NULL
